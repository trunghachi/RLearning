...
* **Cell barcode**
* Cell type markers are genes or proteins with expression specific to a particular cell type. They act as flags that help researchers distinguish different cell types within the data. (examples: CD3, GFAP, Cytokeratin, etc.)
* 
