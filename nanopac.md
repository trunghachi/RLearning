...
1. **Assembly**:  Haploid representation (single sequence) - một tập hợp các contig hoặc scaffold. Một lắp ráp là hoàn chỉnh haploid hoặc đơn giản là hoàn chỉnh nếu nó đại diện cho một bộ gen haploid đầy đủ. Assembly may be derived from a single individual or (usually) a group (for examples, Bacteria - DNA extracted from thousands of individual cells, Hg38 consists of sequence from > 50 individual people)
